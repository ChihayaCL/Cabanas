...
public class EliminarDocumento extends javax.swing.JFrame {
    ...
    //se elimina documento por el código
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        int codigo;
        codigo = Integer.parseInt(txt_codigo.getText());
        
         if(RegistrarDocumento.eliminarDocumento(codigo)){
                JOptionPane.showMessageDialog(this, "Se eliminó documento", "Eliminar Documentos", JOptionPane.INFORMATION_MESSAGE);
            }else{
                JOptionPane.showMessageDialog(this, "NO se eliminó documento", "Eliminar Documentos", JOptionPane.ERROR_MESSAGE);
            }
